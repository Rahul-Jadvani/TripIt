...
class EmailService:
    ...
    def send_validator_added_email(cls, *, validator: "User") -> bool:
        ...
        subject = "You have validator access on 0x.ship"
  ...
  <body style="margin:0;padding:24px;background:#050A13;font-family:'Inter','Segoe UI',system-ui,-apple-system,sans-serif;color:#F8FBFF;">
      ...
      <tr>
        <td align="center">
          <table width="600" cellpadding="0" cellspacing="0" role="presentation" style="background:{cls.BRAND_PRIMARY};border-radius:18px;border:1px solid rgba(255,255,255,0.08);overflow:hidden;box-shadow:0 25px 60px rgba(14,26,75,0.35);">
            <tr>
              <td style="padding:32px 32px 16px;background:linear-gradient(135deg,{cls.BRAND_GRADIENT_START}, {cls.BRAND_GRADIENT_END});color:#050A13;font-size:20px;font-weight:600;">
                <span style="text-transform:uppercase;letter-spacing:2px;font-size:13px;color:#050A13;opacity:0.8;">0x.ship validators</span>
                <div style="font-size:26px;font-weight:700;margin-top:6px;">Welcome aboard</div>
              </td>
            </tr>
            <tr>
              <td style="padding:28px 32px 24px;">
                <p style="margin:0 0 18px;font-size:16px;color:#E2E8FF;">Hey {name},</p>
                <p style="margin:0 0 18px;line-height:1.6;color:{cls.ACCENT_TEXT};">
                  You now have validator access. Head to your dashboard to review projects, set badge limits,
                  and keep the pipeline moving.
                </p>
                <div style="background:rgba(8,12,24,0.9);padding:18px 20px;border-radius:14px;border:1px solid rgba(255,255,255,0.05);margin-bottom:24px;">
                  <div style="font-size:14px;letter-spacing:1px;text-transform:uppercase;color:#7DD4FC;margin-bottom:6px;">What to do next</div>
                  <ul style="margin:0;padding-left:18px;color:#C3D5FF;line-height:1.6;">
    ...
    def _build_validator_welcome_text(*, validator: "User", frontend_url: str) -> str:
        ...
        lines = [
            f"Hey {name},",
            "",
            "You now have validator access on 0x.ship.",
        ...
        <td align="center">
          <table width="600" cellpadding="0" cellspacing="0" role="presentation" style="background:{cls.BRAND_PRIMARY};border-radius:18px;border:1px solid rgba(255,255,255,0.08);overflow:hidden;box-shadow:0 25px 60px rgba(14,26,75,0.35);">
            <tr>
              <td style="padding:32px 32px 16px;background:linear-gradient(135deg,{cls.BRAND_GRADIENT_START}, {cls.BRAND_GRADIENT_END});color:#050A13;font-size:20px;font-weight:600;">
                <span style="text-transform:uppercase;letter-spacing:2px;font-size:13px;color:#050A13;opacity:0.8;">0x.ship validators</span>
                <div style="font-size:26px;font-weight:700;margin-top:6px;">New project assigned</div>
              </td>
            </tr>
            <tr>
              <td style="padding:28px 32px 24px;">
                ...
                <div style="background:rgba(8,12,24,0.9);padding:18px 20px;border-radius:14px;border:1px solid rgba(255,255,255,0.05);margin-bottom:18px;">
                  <div style="font-size:14px;letter-spacing:1px;text-transform:uppercase;color:#FCD34D;margin-bottom:6px;">Project</div>
                  <div style="font-size:20px;font-weight:700;color:#FFFFFF;">{title}</div>
                  <div style="margin-top:6px;color:#C3D5FF;line-height:1.5;">{tagline}</div>
                </div>
