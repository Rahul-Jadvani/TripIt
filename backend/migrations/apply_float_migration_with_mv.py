"""Apply float migration - Drop MV, change columns, recreate MV"""
import os
...
with engine.begin() as conn:
    try:
        ...
        print("[1/3] Dropping materialized view mv_feed_projects...")
        conn.execute(text("DROP MATERIALIZED VIEW IF EXISTS mv_feed_projects CASCADE"))
        print("      Done!\n")

        # Step 2: Alter column types
        print("[2/3] Changing column types to NUMERIC...")
        statements = [
        ...
        print("[3/3] Recreating materialized view...")
        mv_sql = """
...
WHERE p.id IS NOT NULL
        ...
        print("Materialized view has been recreated")
