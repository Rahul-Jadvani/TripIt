  ...
  return (
    <div className="flex flex-row items-center justify-center py-20 h-screen md:h-auto relative w-full">
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full md:h-[40rem] px-4">
        ...
        >
          <h2 className="text-center text-xl md:text-4xl font-black text-foreground">
            Find projects worldwide
          </h2>
          <p className="text-center text-base md:text-lg text-muted-foreground max-w-md mt-2 mx-auto">
            Interactive, on-brand globe. Optimized fallback without extra packages.
          </p>
        </motion.div>
