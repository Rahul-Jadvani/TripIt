...
export const loadingCaptions = {
  ...
  validator: [
    'Gathering verification projects',
    'Loading your dashboard',
    'Retrieving assigned itineraries',
    'Preparing verification queue',
    'Fetching itinerary details',
    'Loading your stats',
    'Getting itineraries ready for review',
    'Assembling your verification list',
    'Loading verification data',
    'Preparing itineraries to review',
    'Gathering assignments',
    'Retrieving your verification queue',
  ],
  admin: [
