...
private fun MainHeader(
    ...
    Row(
        ...
        // Right section with SOS button, location channels button and peer counter
        Row(
            verticalAlignment = Alignment.CenterVertically,
            horizontalArrangement = Arrangement.spacedBy(5.dp)
        ) {
            // SOS Emergency Button
            SOSButton(onClick = { viewModel.sendSOSMessage() })
...
private fun SOSButton(onClick: () -> Unit) {
    ...
    TextButton(
        ...
        colors = ButtonDefaults.textButtonColors(
            contentColor = Color(0xFFFF0000) // Red for emergency
        ),
        ...
        Text(
            ...
            color = Color(0xFFFF0000) // Bright red for visibility
        )
    }
}
